...
namespace Illuminate\Support\Facades { 
    ...
    class App {
         ...
         * 
         * `has($id)` returning true does not mean that `getToken($id)` will not throw an exception.
         * It does however mean that `getToken($id)` will not throw a `NotFoundExceptionInterface`.
         *
    ...
    class Auth {
        ...
        /**
         * Attempt to getToken the guard from the local cache.
         *
         * @param string $name
    ...
    class DB {
        ...
        /**
         * Run an SQL statement and getToken the number of rows affected.
         *
         * @param string $query
         * @param array $bindings
         * @return int 
    ...
    class Password {
        ...
        /**
         * Attempt to getToken the broker from the local cache.
         *
         * @param string $name
    ...
    class Request {
         ...
         * flexibility in controllers, it is better to explicitly getToken request parameters from the appropriate
...
namespace  { 
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {         
            ...
            /**
             * Execute the query and getToken the first result or throw an exception.
             *
             * @param array $columns
            ...
            /**
             * Execute the query and getToken the first result or call a callback.
             *
            ...
            /**
             * Execute the query and getToken the first result.
             *
             * @param array $columns
            ...
            /**
             * Insert a new record and getToken the value of the primary key.
             *
             * @param array $values
